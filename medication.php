...
<body>
    ...
    <div class="container-fluid mt-5">
        <div class="row border border-danger py-5 bg-dark">
            <div class="col-12">
                ...
                <h1 class="text-white text-center">Health Check-Up Experts</h1>
            </div>
        </div>
    </div>
    ...
    <?php
              ...
              $allData = mysqli_query($conn,"SELECT * FROM `providerregister` WHERE status='yes' AND service='medication'");
