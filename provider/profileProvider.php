...
echo "<script>location.href='providerr/providerLogin.php'</script>";
}
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="profileProvider.php">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="../request.php">Requests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="providerLogin.php">Login/Register</a>
                    </li>
                    <li class="nav-item ">
...
<?php
    ...
    include 'config.php';
            ...
            //   $name = $_REQUEST['username'];
              ...
              $allData = mysqli_query($conn,"SELECT * FROM `providerregister` WHERE username='$l_username'");
                            ...
                            <div class='col-md-7'>
                                ...
                                <div class='card p-3 py-4'>
                                    ...
                                    <div class='text-center mt-3'>
                                        ...
                                        <h5 class='mt-2 mb-0 text-uppercase text-Dark'>$row[username]</h5> <br>
                                        ...
                                        <a href='editProfile.php?id=$row[id]'><button class='btn btn-info px-4 ms-3'>Edit Profile</button></a>
                                        </div>
